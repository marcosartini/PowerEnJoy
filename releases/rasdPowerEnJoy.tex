...
\end{figure}
\end{comment}
\includegraphics[height=\textheight]{ActivityStateDiagramsRental.pdf}
\includegraphics[height=\textheight]{ActivityStateDiagramsReservation.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\columnwidth, angle=90, scale=2]{finalWorldAlloy.pdf}
\end{center}
